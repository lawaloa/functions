...
### 2. Save Functions in an R Data File Save function objects: {.unlisted .unnumbered}
...
### 3. Create a Custom R Package: {.unlisted .unnumbered}

If you plan to use your functions frequently across multiple projects, creating a package is a good approach.

Building packages doesn’t have to be intimidating! Thanks to the tidyverse team, getting started is simple with RStudio and the **devtools** and **usethis** packages. In this <a href="https://www.youtube.com/live/EpTkT6Rkgbs?si=rQKwbSDakAFcGilK" target="_blank">one-hour presentation</a>
, you'll learn the fundamentals of R package development and gain the confidence to start building your own packages!

‣ Click [here](https://www.youtube.com/redirect?event=video_description&redir_token=QUFFLUhqbDJuekx2ck1LeUZ3ZmJMNUNoQ1VQM0MtVWpSQXxBQ3Jtc0tsUEV3WDNjdXpLOHlvMnJLYjFJejVocGQwN3lYU0VHQ3BNYU5Pa05HQlZybGIydlZXRzJiSGRRSV9ObFpvTlJIVGc4cmxzSWprZDhxNFdQOHIyR0lZNXJBUFFCX3NpT292QkNIZHBwTXIwN1ZJN1hDcw&q=https%3A%2F%2Fcolorado.rstudio.com%2Frsc%2Fpkg-building%2F&v=EpTkT6Rkgbs){target="_blank"} for **slides**.

‣ Click [here](https://www.youtube.com/redirect?event=video_description&redir_token=QUFFLUhqazE5T1NlMVp1N1NsNnVHOTA5ZVhkQnJiYzJkZ3xBQ3Jtc0trdGJEUFZZR1J2cWtvS0dzbjJGYko1bWlsazQtcjd3ZkZJVEMzZlBXZjZJaTRQcWpSdVVDcHFGb2UtR3pvRER5VElqMkp4eDlOUU12SUhKTjRSVXVQcDF3d2tjeWVsYnFXN0dQNUFLVUhCUnl4ZW9Ocw&q=https%3A%2F%2Fgithub.com%2Fjthomasmock%2Fpkg-building&v=EpTkT6Rkgbs){target="_blank"} for **source code** 

‣ Click [here](https://www.youtube.com/redirect?event=video_description&redir_token=QUFFLUhqbDAzWVB0YThlbkRQdnBiMDJqb0hoQ2ZRai1IZ3xBQ3Jtc0tsblFYYmlvZUJpSnhtS1Y3blVkS3ZQODVsMFlpU3hncm5EV3FoRFdkLV9UOHlhRXlreW8yOUZhQ2ZJVG1jQ1FPMHZSSDFzRUtpVEc1VnBkWXFreHBERmE0RUl0T3cyZTdhMFpvM3YzZHlPR2xET1NLMA&q=https%3A%2F%2Fdevtools.r-lib.org%2F&v=EpTkT6Rkgbs){target="_blank"} for more information on **devtools**

‣ Click [here](https://www.youtube.com/redirect?event=video_description&redir_token=QUFFLUhqbXdiYVc1SWJjVnpTbUdFSlp0anEtS1d4UXdFUXxBQ3Jtc0tsOTJRTjFWakZkOUZ4U0NrdVFoMEd6TGlZaGREUFA0eDBMUTZEaGhSUzh5ZVI3NmdrT3RkSVYtcFFpVEJlN0xiTFVRSlZ6N0sta2NGVEs3VW1LeUtrQVpldm9rZXBVNHNvbXloaE94c0tqbWxxb2hNZw&q=https%3A%2F%2Fusethis.r-lib.org%2F&v=EpTkT6Rkgbs){target="_blank"} for more information on **usethis**

‣ Click [here](https://www.youtube.com/redirect?event=video_description&redir_token=QUFFLUhqbjhjU0g1clNBZVd3UzlCbnFncjd3WGcxcGJGd3xBQ3Jtc0tsZXFCN1lrQzRrRk1FY0tLcm9JeE1VaGVtRVRrNTlsZmlza05JSWxaRC0yc3huN3V6S1FIWXJ6QmptOVNjdTZWSENtM2NxdWk0dFRNTEVXS1hFdXdacUp4QnNWdEpqbjhHTjUyTXpNNjhHNEhRRE05cw&q=https%3A%2F%2Fr-pkgs.org%2Findex.html&v=EpTkT6Rkgbs){target="_blank"} for more  resources on **R Packages book**

‣ Learn how to create a package, the fundamental unit of shareable, reusable, and reproducible R code by reading and studying the 2nd edition of [R Packages](https://r-pkgs.org/){target="_blank"}, by Hadley Wickham and Jennifer Bryan 

‣ This [youtube video: How to Create Your Own Package in RStudio](https://youtu.be/rsQoEgWeJMk?si=j2B5SY_k_4kVqVHT){target="_blank"} is also helpful in creating your own package and storing in GitHub.


### 4. Store Functions in the Global Environment {.unlisted .unnumbered}
...
‣ Wickham, Hadley; Jennifer Bryan. “R Packages (2e).” Accessed Nov 20, 2024.[R Packages (2e)](https://r-pkgs.org/){target="_blank"}